...
public class TestWhileLoop5b {
    public void fifthCand2(){
        int a = 0;
        int b = 0;
        while(a < 5){
            if(b < 5){
        ...
        System.out.println("\tWhile 6 is added to \'k\'");
        ...
        System.out.println("\tWhile 7 is added to \'m\'");
        ...
        System.out.println("\tWhile 8 is added to \'o\'");
    }
